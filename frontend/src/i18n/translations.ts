...
export const translations = {
  pt: {
    ...
    graph: {
      ...
      subtitle: "Visualização determinística da cadeia de verificação e políticas ativas",
  ...
  en: {
    ...
    graph: {
      ...
      subtitle: "Deterministic inspection of identity validation, anomaly telemetry, and active policies",
      badge: "Cypher / Property Graph",
      layer: "Layer",
